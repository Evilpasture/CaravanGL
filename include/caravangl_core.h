...
#define GL_FUNCTIONS_3_3_CORE(X)                                               \
  ...
  X(void, TexImage1D, GLenum target, GLint level, GLint internalformat,        \
    GLsizei width, GLint border, GLenum format, GLenum type, const void *data) \
  ...
  X(void, TexSubImage3D, GLenum target, GLint level, GLint xoffset,            \
    GLint zoffset, GLint yoffset, GLsizei width, GLsizei height,               \
